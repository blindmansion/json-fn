...
2. **Every function _declaration_ is fully typed.** All params annotated with
...
**Why deferred — it is _not_ free.** The term scope (variables) is a parent
...
Inference stays an _internal_ tool (lambda bodies at builtin call sites,
...
_list_ signatures in the sketch. Host/external functions are **injected** by the
